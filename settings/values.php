...
$mainValues = [
    ...
    'customer_custome_plan_name'=>'یه اسم واسه اشتراکت انتخاب کن ( حروف انگیلیسی و عدد باهم وارد کنید )',
    ...
    'increase_wallet_cart_to_cart'=>"♻️  یه تصویر از فیش واریزی برام ارسال کن :
...
",
    ...
    'buy_account_cart_to_cart'=>"♻️  یه تصویر از فیش واریزی یا شماره پیگیری برام ارسال کن :

🔰 <code>ACCOUNT-NUMBER</code> - HOLDER-NAME

✅ بعد از اینکه پرداختت تایید شد ( لینک سرور ) به صورت خودکار از طریق همین ربات برات ارسال میشه!",
    'renew_ccount_cart_to_cart'=>"♻️  یه تصویر از فیش واریزی یا شماره پیگیری برام ارسال کن :
...
",
    ...
    'start_message'=>'سلااام به ربات استارلینک وی پی ان خوش اومدی 🫡🌸

🚪 /start',
    'new_member_joined'=>"📢 | یه کابر جدید عضو ربات شد :
...
💰مقدار تخفیف: AMOUNT تومان
⁮⁮ ⁮⁮",
"send_config_uuid"=>"❗️| لینک کانفیگ رو برام بفرس اطلاعات کامل رو تحویلت بدم 🤭",
...
از این بخش میتوانید خرید تکی و خرید انبوه داشته باشید و همچنین کانفیگ های خریداری شده را مدیریت کنید",
    ...
    'no_server_available'=>"😔 |   هیچ سرور فعالی نداریم لطفا بعدا مجدد تست کن",
...
$buttonValues = [
    ...
    'application_links'=>'🧩 لیست اپلیکیشن ها',
